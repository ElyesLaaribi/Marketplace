...
<template>
  <div class="flex h-screen">
    <!-- Fixed sidebar -->
    <aside
      class="fixed flex flex-col w-64 h-screen px-5 py-8 overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-900 dark:border-gray-700 z-10"
    >
      <a href="#">
        <img
          class="w-auto h-7"
