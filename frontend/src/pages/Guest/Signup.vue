...
<template>
  ...
  <GuestLayout>
    <h2 class="mt-10 text-center text-2xl/9 font-bold tracking-tight text-gray-900">Create new client account</h2>
    ...
    <div class="mt-4 sm:mx-auto sm:w-full sm:max-w-sm">
      ...
      <p class="mt-10 text-center text-sm/6 text-gray-500">
        Create an account as a  lessor
        {{ ' ' }}
        <router-link :to="{name:'Signuplessor'}" class="font-semibold text-indigo-600 hover:text-indigo-500">Click here</router-link>
      </p>
