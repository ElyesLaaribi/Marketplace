...
<template>
  <div class="flex h-screen bg-white dark:bg-gray-900">
    <!-- Sidebar - collapsible -->
    <aside
      :class="`fixed flex flex-col h-screen overflow-y-auto bg-white border-r rtl:border-r-0 rtl:border-l dark:bg-gray-800 dark:border-gray-700 z-10 transition-all duration-300 shadow-md ${
    ...
    >
      ...
      >
        <a href="#" class="flex items-center gap-2">
          <div
            class="flex items-center justify-center w-8 h-8 bg-blue-600 text-white rounded-md"
          >
            <svg
